 ...
 */
public class LemStatPageCurrent extends AbstractPage {
    public static final String LOCATOR = "/lemstatcurrent";
    ...
    protected void handleGet(Request req, Response res, Map<String, Object> attributes) {
        List<Game> games = MainApplication.PROVIDER.currentMonthGames();
